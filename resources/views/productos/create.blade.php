...
<head>
    ...
    <title>Nuevo producto | FactuVE</title>
        ...
        <div class="form-card">
            ...
            <form action="{{ route('productos.store') }}" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="codigo" name="codigo" value="{{ old('codigo') }}" placeholder="Ej: LAPTOP-HP-001" required>
                    <p class="mt-1 text-sm text-gray-500">Código único para identificar el producto</p>
                </div>

                <div class="input-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Laptop HP Pavilion" required>
                </div>

                <div class="input-group">
                    <label for="descripcion">Descripción</label>
                    <input type="text" id="descripcion" name="descripcion" value="{{ old('descripcion') }}" placeholder="Opcional">
                </div>
